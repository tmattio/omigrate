  ...
  | `Unknown_driver s ->
      Printf.sprintf
        "The driver %S does not exist.\n\n\
         Hint: maybe you forgot to install the corresponding driver?." s
  | `Bad_uri s -> Printf.sprintf "The URI is not valid: %S." s
  | `Invalid_source s -> Printf.sprintf "The source is not valid: %S." s
